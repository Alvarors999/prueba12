...
?>
		...
		<section>
			<div class="view">
				<img alt class="bg" src="<?php echo bloginfo('template_directory');?>/images/pexels-md-iftekhar-uddin-emon-403495.jpg" /><img alt class="bg" src="<?php echo bloginfo('template_directory');?>/images/pexels-md-iftekhar-uddin-emon-403495.jpg" />
