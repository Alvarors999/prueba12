                                							...
                                							<div class="col-md-8">
                                								<div class="row post">
                                									...
                                									<div class="col-md-9 border-bottom">
                                										<div class="post-body background-10-b">
                                											<div class="post-image">
                                												<a class="page-transition" href="blog-single-1.html"><img class="fluid-width" src="<?php echo bloginfo('template_directory');?>/images/bg/picjumbo/picjumbo.com_HNCK1805.jpg"></a>
                                											</div>
